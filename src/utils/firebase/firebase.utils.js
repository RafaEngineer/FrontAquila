...
import {getAuth, GoogleAuthProvider, signInWithRedirect, signInWithEmailAndPassword, signOut, onAuthStateChanged} from 'firebase/auth';
...
export const signInWithEmailAndPasswords = () => signInWithEmailAndPassword(auth, email, password)
